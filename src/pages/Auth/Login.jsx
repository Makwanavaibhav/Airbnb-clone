    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="border-b border-gray-200 px-6 py-4 flex justify-between items-center">
          ...
          <h2 className="text-[16px] font-semibold text-gray-900 mx-auto">Log in or sign up</h2>
          <div className="w-8"></div> {/* Spacer to keep title centered */}
        </div>

        <div className="p-6">
          <h3 className="text-[22px] font-semibold text-gray-900 mb-6">Welcome to Airbnb</h3>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="text-[12px] text-gray-600 mt-3 font-light">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4">
              <div className="w-full cursor-pointer flex items-center justify-between px-4 py-3 border border-black rounded-lg hover:bg-gray-50 transition text-gray-900 font-semibold text-[14px]">
